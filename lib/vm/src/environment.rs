...
use wasmer::{AsStoreMut, AsStoreRef, FunctionEnvMut, Instance as WasmerInstance, Memory, Value};
...
pub struct Environment<A: BackendApi + 'static> {
    pub api: A,
...
pub fn process_gas_info<A: BackendApi>(
